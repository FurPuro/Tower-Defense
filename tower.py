...
from config import *
class Tower:
    def __init__(self,x,y,w,h,state,colorOrImagePath,colorOrImagePathProjectile,id,price,upgradePrice,damage,upgradeDamage,attacksPerSecond,upgradedAttacksPerSecond,maxDistance,upgradedMaxDistance):
